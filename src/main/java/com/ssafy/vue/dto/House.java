...
//	
	...
	public void setType(String type) {
		...
		if(type.equals("2"))
			this.type = APT_RENT;
		if(type.equals("3"))
			this.type = HOUSE_DEAL;
		if(type.equals("4"))
			this.type = HOUSE_RENT;
	}
...
//         return dong.compareTo(o.dong);
//      }
      return Integer.parseInt(this.dealAmount.trim().replace(",", ""))-Integer.parseInt(o.dealAmount.trim().replace(",", ""));
   }
   
   @Override
   public boolean equals(Object obj) {
      House hd = (House) obj;
      System.out.println(hd.aptName+" :: "+this.aptName);
      return this.aptName.trim().equals(hd.aptName.trim());
   }
}
